...
class TextMelSpeakerBatchCollate(object):
    def __call__(self, batch):
        ...
        return {"x": x, "x_lengths": x_lengths, "y": y, "y_lengths": y_lengths, "spk_id": spk_id}
...
class UnitDurationMelSPeakerDataset(torch.utils.data.Dataset):
    ...
    def get_unit_duration(self, filepath):
        # Loads preprocessed units and durations rescaled to propper frame-rate
    ...
    def __getitem__(self, index):
        ...
        item = {"y": mel, "x": unit, "x_duration": duration, "spk_id": spk_id}
        return item
...
class UnitDurationMelSpeakerBatchCollate(object):
    def __call__(self, batch):
        ...
        return {
            ...
            "x_duration_lengths": x_duration_lengths,
            "y": y,
            "y_lengths": y_lengths,
            "spk_id": spk_id,
        }
